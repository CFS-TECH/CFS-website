        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-8">
          ...
          >
            ...
            >
              ...
              <button className="flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-[#102a43] border border-gray-200 font-bold rounded-xl hover:border-[#094a84] transition-all duration-300 shadow-sm hover:-translate-y-1">
